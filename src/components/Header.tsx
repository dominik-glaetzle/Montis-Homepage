...
function Header() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-16 md:py-24 relative">
      {/* TOP RIGHT: Language always visible, Dark Mode only >= md */}
      ...
      <div className="grid grid-cols-1 gap-10 items-center md:grid-cols-2">
        ...
        <div className="text-center md:text-left order-2 md:order-1">
          <h1 className="text-6xl font-extrabold tracking-tight md:text-8xl text-black dark:text-white">
            Montis
          </h1>
          <p className="mt-6 max-w-xl text-2xl leading-relaxed text-slate-600 md:text-3xl dark:text-white">
